...
1. Make an [Issue](https://github.com/3d-group/unity-simple-localization/issues/new)
...
```json
    {
        "dependencies": {
            "com.3d-group.unity-simple-localization": "https://github.com/YOUR_USER/unity-simple-localization.git"
        }
    }
```
